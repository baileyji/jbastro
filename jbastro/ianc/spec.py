...
def runlblrtm(lamrange, pwv=2., zang=0., alt=4.2, co2=390, res=200, dotrans=True, dorad=False,
    ...
    :OUTPUTS:
       A 2- or 3-tuple:  First element is wavelength in microns,
       second element is transmittance (if requested), third element
       is radiance (if both requested; otherwise radiance is second
       element)
...
def normalizeSpecFlat(flatdat, nspec=1, minsep=50, median_width=51, readnoise=40, badpixelmask=None):
